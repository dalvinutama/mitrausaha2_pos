            ...
            <div class="flex-1 overflow-y-auto p-4 lg:p-8 bg-gray-100 dark:bg-gray-900 custom-scrollbar space-y-8 transition-colors duration-300">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md flex flex-col md:flex-row items-center justify-between gap-4 relative overflow-hidden transition-colors">
                    ...
                    <div class="relative z-10 flex items-center gap-5 w-full">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Hasil Pencarian Global</p>
                    ...
                    <div class="relative z-10 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-5 py-3 rounded-2xl shrink-0 text-center w-full md:w-auto transition-colors">
                        <p class="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-0.5">Total Ditemukan</p>
                        <p class="text-2xl font-black text-gray-800 dark:text-white">{{ $totalFound }} <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Data</span></p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center justify-center py-20 opacity-70">
                    ...
                    <h3 class="text-xl font-black text-gray-700 dark:text-gray-300">Tidak ada yang cocok!</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 text-center max-w-md">Sistem telah memindai seluruh material, supplier, dan transaksi namun tidak menemukan data dengan kata kunci <strong class="text-gray-800 dark:text-white">"{{ $keyword }}"</strong>.</p>
                </div>
                @else
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md flex flex-col h-max transition-colors">
                            <div class="bg-indigo-50/80 dark:bg-indigo-900/20 px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="font-bold text-indigo-900 dark:text-indigo-200 tracking-wide text-sm">Material Master</h3>
                                </div>
                            ...
                            <div class="p-0 divide-y divide-gray-200 dark:divide-gray-700 transition-colors">
                                ...
                                <a href="{{ Route::has('persediaan') ? route('persediaan') : '#' }}" class="flex items-center justify-between p-5 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/10 transition-colors group">
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 mt-1.5">
                                            ...
                                            <span class="text-[10px] text-gray-500 dark:text-gray-400 font-medium">{{ $p->kategori->nama_kategori ?? 'Tanpa Kategori' }}</span>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <span class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-0.5">Stok Saat Ini</span>
                                ...
                                <div class="p-8 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="text-xs font-bold">Nihil data material.</p>
                                </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md flex flex-col h-max transition-colors">
                            <div class="bg-blue-50/80 dark:bg-blue-900/20 px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="font-bold text-blue-900 dark:text-blue-200 tracking-wide text-sm">Mitra / Supplier</h3>
                                </div>
                            ...
                            <div class="p-0 divide-y divide-gray-200 dark:divide-gray-700 transition-colors">
                                ...
                                <a href="{{ Route::has('supplier') ? route('supplier') : '#' }}" class="flex flex-col p-5 hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors group">
                                    <div class="flex justify-between items-start mb-2">
                                        ...
                                        @if($s->status == 'Aktif')
                                            <span class="text-[9px] font-black text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800/50 px-2 py-0.5 rounded uppercase transition-colors shadow-sm">Aktif</span>
                                        @else
                                            <span class="text-[9px] font-black text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800/50 px-2 py-0.5 rounded uppercase transition-colors shadow-sm">Nonaktif</span>
                                        @endif
                                    </div>
                                    <div class="grid grid-cols-2 gap-2 text-[11px]">
                                        <p class="text-gray-500 dark:text-gray-400 font-medium"><i class="fas fa-user text-gray-400 dark:text-gray-600 w-4"></i> {{ $s->nama_pic ?? 'Tanpa PIC' }}</p>
                                ...
                                <div class="p-8 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="text-xs font-bold">Nihil data supplier.</p>
                                </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md flex flex-col h-full min-h-[400px] transition-colors">
                            <div class="bg-emerald-50/80 dark:bg-emerald-900/20 px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="font-bold text-emerald-900 dark:text-emerald-200 tracking-wide text-sm">Riwayat Transaksi (Surat Jalan/Nota)</h3>
                                </div>
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <table class="w-full text-sm text-left border-collapse">
                                    <thead class="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-wider bg-gray-100 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700 transition-colors">
                                        <tr>
                                            <th class="px-6 py-4">Nomor & Tgl</th>
                                        ...
                                        <tr class="hover:bg-emerald-50/30 dark:hover:bg-emerald-900/10 transition-colors">
                                            ...
                                            <td class="px-6 py-4">
                                                @if(strtolower($t->jenis_transaksi) == 'masuk')
                                                    <span class="bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800/50 px-3 py-1 rounded-lg text-[10px] font-black tracking-wider uppercase inline-flex items-center gap-1 transition-colors shadow-sm"><i class="fas fa-arrow-down"></i> MASUK</span>
                                                @elseif(strtolower($t->jenis_transaksi) == 'keluar')
                                                    <span class="bg-red-50 dark:bg-red-900/30 text-[#D00000] dark:text-red-400 border border-red-200 dark:border-red-800/50 px-3 py-1 rounded-lg text-[10px] font-black tracking-wider uppercase inline-flex items-center gap-1 transition-colors shadow-sm"><i class="fas fa-arrow-up"></i> KELUAR</span>
                                                @else
                                            ...
                                            <td class="px-6 py-4">
                                                <p class="font-bold text-gray-700 dark:text-gray-300 text-xs">{{ $t->tujuan ?? ($t->supplier->nama_supplier ?? 'Internal') }}</p>
                                                @if($t->catatan)
                                ...
                                <div class="flex flex-col items-center justify-center h-full min-h-[300px] text-gray-500 dark:text-gray-400 p-8">
                                    ...
                                    <p class="text-sm font-bold text-center">Nihil data riwayat transaksi.</p>
                                </div>
                                @endif
                            </div>
                        </div>
